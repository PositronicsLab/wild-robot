...
//    wb_vicon_data_ptr _wb_vicon_data;        //< Vicon data container
  ...
  public:
    ...
    virtual void Load( physics::ModelPtr model, sdf::ElementPtr sdf ) {
      ...
      printf( "video_t0[%d], vicon_t0[%f], first_valid_vicon_state[%d]\n", _wb_video_session->base_safe_start_frame(), _wb_video_session->vicon_start_time(), _wb_video_session->vicon_states_to_ignore() );
    ...
    virtual void Update( ) {
      ...
      // throw out states until the initial vicon state is found.
